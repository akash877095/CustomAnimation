...
import com.overlaydemo.utils.showcaseViews.shape.CircleShape;
import com.overlaydemo.utils.showcaseViews.shape.NoShape;
import com.overlaydemo.utils.showcaseViews.shape.OvalShape;
import com.overlaydemo.utils.showcaseViews.shape.RectangleShape;
import com.overlaydemo.utils.showcaseViews.shape.Shape;
import com.overlaydemo.utils.showcaseViews.target.Target;
import com.overlaydemo.utils.showcaseViews.target.ViewTarget;
...
public class MaterialShowcaseView extends FrameLayout implements View.OnTouchListener, View.OnClickListener {
    ...
    public static final int DEFAULT_SHAPE_PADDING = 2;
    ...
    private void init(Context context) {
        ...
        View contentView = LayoutInflater.from(getContext()).inflate(R.layout.overlay_layout, this, true);
        mContentBox = contentView.findViewById(R.id.content_box);
        mNumberTextView = contentView.findViewById(R.id.numberText);
        mTitleTextView = contentView.findViewById(R.id.tvTitle);
        mContentTextView = contentView.findViewById(R.id.descriptionText);
        mNextButton = contentView.findViewById(R.id.btnNextButton);
        mSkipButton = contentView.findViewById(R.id.btnSkipButton);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.btnNextButton) {
            hide();
        } else if (v.getId() == R.id.btnSkipButton) {
            skip();
        }
    }
    ...
    private void setOverlayLayoutPadding(int top, int bottom, int left, int right) {
        if (mContentBox != null) {
            mContentBox.setPadding(left, top, right, bottom);
        }
    }

    private void setNumberText(CharSequence contentText) {
        if (mNumberTextView != null && !contentText.equals("")) {
            mNumberTextView.setText(contentText);
        }
    }

    private void setNextButtonText(CharSequence contentText) {
        if (mNextButton != null && !contentText.equals("")) {
            mNextButton.setText(contentText);
        }
    }
    ...
    public static class Builder {
        ...
        /**
         * Set the Number text shown on the ShowcaseView as the title.
         */
        public Builder setNumberText(CharSequence text) {
            showcaseView.setNumberText(text);
            return this;
        }
         ...
         * Set the Number text shown on the ShowcaseView as the title.
         */
        public Builder setOverlayLayoutPadding(int top, int bottom, int left, int right) {
            showcaseView.setOverlayLayoutPadding(top, bottom, left, right);
            return this;
        }
         ...
         * Set the Number text shown on the ShowcaseView as the title.
         */
        public Builder setNextButtonText(CharSequence text) {
            showcaseView.setNextButtonText(text);
            return this;
        }
